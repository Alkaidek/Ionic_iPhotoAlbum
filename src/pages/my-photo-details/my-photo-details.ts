...
@IonicPage()
@Component({
  selector: 'page-my-photo-details',
  templateUrl: 'my-photo-details.html',
})
export class MyPhotoDetailsPage {
  parameter1= []
  commentList = []
  rateList = []
  parameter2
  ...
  constructor(private ofAuth:AngularFireAuth, private fdb: AngularFireDatabase,
    public navCtrl: NavController, public navParams: NavParams) {
      ...
      console.log("Parametr1[0]: "+this.parameter1[0])
      this.parameter2 = navParams.get('param2');
      console.log("Parametr2: "+this.parameter2)
